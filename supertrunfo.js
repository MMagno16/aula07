var carta1 = {
  ...
  function obtemAtributoSelecionado() {
    ...
    for(var i = 0; i < radioAtributos.length; i++) {
      if(radioAtributos[i].ckecked == true) {
    ...
    function jogar() {
      ...
      if (valorCartaJogador > valorCartaMaquina) {
        elementoResultado.innerHTML = "A sua princesa era " + cartaJogador.nome + " e a outra princesa era " + cartaMaquina.nome + " você venceu!"
        
      } else if(valorCartaJogador > valorCartaMaquina) {
        elementoResultado.innerHTML = "A sua princesa era " + cartaJogador.nome + " e a outra princesa era " + cartaMaquina.nome + " você perdeu!"
